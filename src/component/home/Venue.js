...
const Venue = () => {
  ...
  return (
    ...
    <div id='venue' className='row m-0 p-0'>
      <div className={(width>768)?"col-6 SV-map m-0 p-0":"col-12 SV-map m-0 p-0"}>
      ...
      <div className={(width>768)?"col-6 SV-info":"col-12 SV-info"}>
        <h2 className="FM1">VENUE<span className='Icon'><MdKeyboardArrowRight/></span>AOT Block D</h2>
